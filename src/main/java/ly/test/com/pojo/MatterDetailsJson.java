...
public class MatterDetailsJson {
    ...
    private List<String> inspectItemContentList;

    public MatterDetailsJson() {
    }

    public MatterDetailsJson(int matterId, String matterTitle, String matterType, String frequency, String workName, String entrustDept, String workChildrenName, String implementationPerson, String testType, List<String> inspectItemContentList) {
    ...
    public List<String> getInspectItemContentList() {
        return inspectItemContentList;
    }

    public void setInspectItemContentList(List<String> inspectItemContentList) {
        this.inspectItemContentList = inspectItemContentList;
    }
}
